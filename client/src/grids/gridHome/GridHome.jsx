import '../../component/styles/gridHome.css';
...
const GridHome = () => {
    return (
        <div className='content_grid_home'>
            <div class="grid-container">
                <div class="grid-item grid-color-0"></div>
                ...
                <div class="grid-item grid-color-10"></div>
                <div class="grid-item grid-color-11"></div>
            </div>
        </div>
